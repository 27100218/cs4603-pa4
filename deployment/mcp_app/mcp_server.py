...
NOTE (Bonus C): this is a self-contained copy of tools/mcp_server.py, kept
inside deployment/mcp_app/ so the Databricks App source path (which only
syncs this directory) does not need to reach outside itself to import the
tool definitions. Content is identical to the original; do not modify.
"""
